//importing the necessary import statements of fab, editicon, modal, formcontrol, formhelpertext, inputlabel, gridlist, profile.css and so on
...
// Creating Profile class component to render the profile page as per the design
class Profile extends Component {
    ...
    componentDidMount() {
        if (this.state.isLoggedIn) {
            ...
            //Passing XMLHttpRequest as a get request
            xhr.open("GET", this.props.baseUrl + "?access_token="+ that.state.accessToken);

            //sending the XMLHttpRequest data
            xhr.send(data);
...
//exporting the default statement for profile
